...
points = {
	{name = "Pelvis_L", body = "Pelvis", point = {0.000000, 0.170516, 0.119361,},},
	{name = "Pelvis_R", body = "Pelvis", point = {0.000000, -0.170516, 0.119361,},},
	{name = "Pelvis_Back", body = "Pelvis", point = {-0.127887, 0.000000, 0.119361,},},
	{name = "Pelvis_Front", body = "Pelvis", point = {0.127887, 0.000000, 0.119361,},},
	{name = "Thigh_R", body = "Thigh_R", point = {0.069240, -0.000000, -0.259649,},},
	{name = "Heel_Medial_R", body = "Foot_R", point = {-0.108000, 0.058000, -0.085000,},},
	{name = "Heel_Lateral_R", body = "Foot_R", point = {-0.108000, -0.058000, -0.085000,},},
	{name = "Toe_R", body = "Foot_R", point = {0.052863, 0.000000, -0.085000,},},
	{name = "Thigh_L", body = "Thigh_L", point = {0.069240, 0.000000, -0.259649,},},
	{name = "Heel_Medial_L", body = "Foot_L", point = {-0.108000, -0.058000, -0.085000,},},
	{name = "Heel_Lateral_L", body = "Foot_L", point = {-0.108000, 0.058000, -0.085000,},},
	{name = "Toe_L", body = "Foot_L", point = {0.052863, 0.000000, -0.085000,},},
	{name = "UpperTrunk_Front", body = "UpperTrunk", point = {0.085681, 0.000000, 0.064261,},},
	{name = "UpperTrunk_Back", body = "UpperTrunk", point = {-0.096391, 0.000000, 0.085681,},},
	{name = "ProximalMetacarpal_Medial_R", body = "Hand_R", point = {-0.031961, 0.023971, -0.031961,},},
	{name = "ProximalMetacarpal_Lateral_R", body = "Hand_R", point = {0.031961, 0.023971, -0.031961,},},
	{name = "DistalMetacarpal_Medial_R", body = "Hand_R", point = {-0.031961, 0.023971, -0.095883,},},
	{name = "DistalMetacarpal_Lateral_R", body = "Hand_R", point = {0.031961, 0.023971, -0.095883,},},
	{name = "ProximalMetacarpal_Medial_L", body = "Hand_L", point = {-0.031961, -0.023971, -0.031961,},},
	{name = "ProximalMetacarpal_Lateral_L", body = "Hand_L", point = {0.031961, -0.023971, -0.031961,},},
	{name = "DistalMetacarpal_Medial_L", body = "Hand_L", point = {-0.031961, -0.023971, -0.095883,},},
	{name = "DistalMetacarpal_Lateral_L", body = "Hand_L", point = {0.031961, -0.023971, -0.095883,},},
},
constraint_sets = {
},
frames = {
	...
	markers = {
		...
		L_IPS = 	{ -0.119361, 0.119361, 0.119361,},
		R_IPS = 	{ -0.119361, -0.119361, 0.119361,},},
	visuals = {{
		src         = "pelvis.obj",
		dimensions  = 	{ 0.315000, 0.393750, 0.255774,},
	...
	visuals = {{
		src         = "thighR.obj",
		dimensions  = 	{ 0.173099, 0.138480, 0.415439,},
...
{		{ 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	...
	body = {
		mass   = 1.238400,
		com = 	{ -0.021906, 0.000000, -0.042500,},
		inertia = 
	...
	joint = 
		...
		{ 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		R_FM1 = 	{ 0.150139, 0.021448, -0.032173,},
		R_FM2 = 	{ 0.150139, 0.000000, -0.032173,},
		R_FM5 = 	{ 0.150139, -0.021448, -0.032173,},
		R_FCC = 	{ -0.064345, 0.000000, -0.032173,},},
	visuals = {{
		src         = "footR.obj",
		dimensions  = 	{ 0.214484, 0.116000, 0.085000,},
		mesh_center = 	{ -0.000758, 0.000000, -0.042500,},
		color       = 	{ 0.200000, 0.700000, 0.300000,},
		},},
	},
	{name   = "Thigh_L",
...
{		{ 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	...
	joint = 
		...
		{ 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		L_FM1 = 	{ 0.150139, -0.021448, -0.032173,},
		L_FM2 = 	{ 0.150139, 0.000000, -0.032173,},
		L_FM5 = 	{ 0.150139, 0.021448, -0.032173,},
	...
	joint = 
		...
		{ 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		SXS = 	{ 0.096438, 0.000000, 0.096438,},
		MAI = 	{ -0.096438, 0.000000, 0.096438,},
		LV1 = 	{ -0.096438, 0.000000, 0.000000,},
		LV3 = 	{ -0.096438, 0.000000, -0.048219,},},
	visuals = {{
		src         = "middleTrunk.obj",
		dimensions  = 	{ 0.283500, 0.346500, 0.289313,},
	...
	joint = 
		{},
	markers = {
		CV7 = 	{ -0.085681, 0.000000, 0.171361,},
		SJN = 	{ 0.089965, 0.000000, 0.128521,},
		TV2 = 	{ -0.085681, 0.000000, 0.128521,},},
	visuals = {{
		src         = "upperTrunk.obj",
		dimensions  = 	{ 0.159469, 0.303750, 0.224912,},
