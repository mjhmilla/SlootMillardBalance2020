...
metadata = {
	 ...
	 subject_heelAnkleXOffset = {0.0840},
...
points = {
	{name = "Pelvis_L", body = "Pelvis", point = {0.000000, 0.183069, 0.128148,},},
	{name = "Pelvis_R", body = "Pelvis", point = {0.000000, -0.183069, 0.128148,},},
	{name = "Pelvis_Back", body = "Pelvis", point = {-0.137302, 0.000000, 0.128148,},},
	{name = "Pelvis_Front", body = "Pelvis", point = {0.137302, 0.000000, 0.128148,},},
	{name = "Thigh_R", body = "Thigh_R", point = {0.074337, -0.000000, -0.278764,},},
	{name = "Heel_Medial_R", body = "Foot_R", point = {-0.084000, 0.057500, -0.079000,},},
	{name = "Heel_Lateral_R", body = "Foot_R", point = {-0.084000, -0.057500, -0.079000,},},
	{name = "Toe_R", body = "Foot_R", point = {0.088705, 0.000000, -0.079000,},},
	{name = "Thigh_L", body = "Thigh_L", point = {0.074337, 0.000000, -0.278764,},},
	{name = "Heel_Medial_L", body = "Foot_L", point = {-0.084000, -0.057500, -0.079000,},},
	{name = "Heel_Lateral_L", body = "Foot_L", point = {-0.084000, 0.057500, -0.079000,},},
	{name = "Toe_L", body = "Foot_L", point = {0.088705, 0.000000, -0.079000,},},
	{name = "UpperTrunk_Front", body = "UpperTrunk", point = {0.091988, 0.000000, 0.068991,},},
	{name = "UpperTrunk_Back", body = "UpperTrunk", point = {-0.103487, 0.000000, 0.091988,},},
	{name = "ProximalMetacarpal_Medial_R", body = "Hand_R", point = {-0.034314, 0.025736, -0.034314,},},
	{name = "ProximalMetacarpal_Lateral_R", body = "Hand_R", point = {0.034314, 0.025736, -0.034314,},},
	{name = "DistalMetacarpal_Medial_R", body = "Hand_R", point = {-0.034314, 0.025736, -0.102942,},},
	{name = "DistalMetacarpal_Lateral_R", body = "Hand_R", point = {0.034314, 0.025736, -0.102942,},},
	{name = "ProximalMetacarpal_Medial_L", body = "Hand_L", point = {-0.034314, -0.025736, -0.034314,},},
	{name = "ProximalMetacarpal_Lateral_L", body = "Hand_L", point = {0.034314, -0.025736, -0.034314,},},
	{name = "DistalMetacarpal_Medial_L", body = "Hand_L", point = {-0.034314, -0.025736, -0.102942,},},
	{name = "DistalMetacarpal_Lateral_L", body = "Hand_L", point = {0.034314, -0.025736, -0.102942,},},
},
constraint_sets = {
},
frames = {
	...
	markers = {
		...
		L_IPS = 	{ -0.128148, 0.128148, 0.128148,},
		R_IPS = 	{ -0.128148, -0.128148, 0.128148,},},
	visuals = {{
		src         = "pelvis.obj",
		dimensions  = 	{ 0.224000, 0.280000, 0.274604,},
	...
	visuals = {{
		src         = "thighR.obj",
		dimensions  = 	{ 0.185843, 0.148674, 0.446023,},
...
{		{ 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	...
	body = {
		mass   = 1.019100,
		com = 	{ 0.008432, 0.000000, -0.039500,},
		inertia = 
	...
	joint = 
		...
		{ 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		R_FM1 = 	{ 0.161192, 0.023027, -0.034541,},
		R_FM2 = 	{ 0.161192, 0.000000, -0.034541,},
		R_FM5 = 	{ 0.161192, -0.023027, -0.034541,},
		R_FCC = 	{ -0.069082, 0.000000, -0.034541,},},
	visuals = {{
		src         = "footR.obj",
		dimensions  = 	{ 0.230274, 0.115000, 0.079000,},
		mesh_center = 	{ 0.031137, 0.000000, -0.039500,},
		color       = 	{ 0.200000, 0.700000, 0.300000,},
		},},
	},
	{name   = "Thigh_L",
...
{		{ 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	...
	joint = 
		...
		{ 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		L_FM1 = 	{ 0.161192, -0.023027, -0.034541,},
		L_FM2 = 	{ 0.161192, 0.000000, -0.034541,},
		L_FM5 = 	{ 0.161192, 0.023027, -0.034541,},
		L_FCC = 	{ -0.069082, 0.000000, -0.034541,},},
	visuals = {{
		src         = "footL.obj",
		dimensions  = 	{ 0.230274, 0.115000, 0.079000,},
		mesh_center = 	{ 0.031137, 0.000000, -0.039500,},
	...
	joint = 
		...
		{ 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		SXS = 	{ 0.103537, 0.000000, 0.103537,},
		MAI = 	{ -0.103537, 0.000000, 0.103537,},
		LV1 = 	{ -0.103537, 0.000000, 0.000000,},
		LV3 = 	{ -0.103537, 0.000000, -0.051769,},},
	visuals = {{
		src         = "middleTrunk.obj",
		dimensions  = 	{ 0.201600, 0.246400, 0.310612,},
	...
	joint = 
		{},
	markers = {
		CV7 = 	{ -0.091988, 0.000000, 0.183977,},
		SJN = 	{ 0.096588, 0.000000, 0.137983,},
		TV2 = 	{ -0.091988, 0.000000, 0.137983,},},
	visuals = {{
		src         = "upperTrunk.obj",
		dimensions  = 	{ 0.170625, 0.325000, 0.241470,},
