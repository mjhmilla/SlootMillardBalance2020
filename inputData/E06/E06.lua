...
metadata = {
	 ...
	 subject_heelAnkleXOffset = {0.1130},
...
points = {
	{name = "Pelvis_L", body = "Pelvis", point = {0.000000, 0.136411, 0.095487,},},
	{name = "Pelvis_R", body = "Pelvis", point = {0.000000, -0.136411, 0.095487,},},
	{name = "Pelvis_Back", body = "Pelvis", point = {-0.102308, 0.000000, 0.095487,},},
	{name = "Pelvis_Front", body = "Pelvis", point = {0.102308, 0.000000, 0.095487,},},
	{name = "Thigh_R", body = "Thigh_R", point = {0.079056, -0.000000, -0.296462,},},
	{name = "Heel_Medial_R", body = "Foot_R", point = {-0.113000, 0.059500, -0.101000,},},
	{name = "Heel_Lateral_R", body = "Foot_R", point = {-0.113000, -0.059500, -0.101000,},},
	{name = "Toe_R", body = "Foot_R", point = {0.068233, 0.000000, -0.101000,},},
	{name = "Thigh_L", body = "Thigh_L", point = {0.079056, 0.000000, -0.296462,},},
	{name = "Heel_Medial_L", body = "Foot_L", point = {-0.113000, -0.059500, -0.101000,},},
	{name = "Heel_Lateral_L", body = "Foot_L", point = {-0.113000, 0.059500, -0.101000,},},
	{name = "Toe_L", body = "Foot_L", point = {0.068233, 0.000000, -0.101000,},},
	{name = "UpperTrunk_Front", body = "UpperTrunk", point = {0.090666, 0.000000, 0.067999,},},
	{name = "UpperTrunk_Back", body = "UpperTrunk", point = {-0.101999, 0.000000, 0.090666,},},
	{name = "ProximalMetacarpal_Medial_R", body = "Hand_R", point = {-0.035184, 0.026388, -0.035184,},},
	{name = "ProximalMetacarpal_Lateral_R", body = "Hand_R", point = {0.035184, 0.026388, -0.035184,},},
	{name = "DistalMetacarpal_Medial_R", body = "Hand_R", point = {-0.035184, 0.026388, -0.105552,},},
	{name = "DistalMetacarpal_Lateral_R", body = "Hand_R", point = {0.035184, 0.026388, -0.105552,},},
	{name = "ProximalMetacarpal_Medial_L", body = "Hand_L", point = {-0.035184, -0.026388, -0.035184,},},
	{name = "ProximalMetacarpal_Lateral_L", body = "Hand_L", point = {0.035184, -0.026388, -0.035184,},},
	{name = "DistalMetacarpal_Medial_L", body = "Hand_L", point = {-0.035184, -0.026388, -0.105552,},},
	{name = "DistalMetacarpal_Lateral_L", body = "Hand_L", point = {0.035184, -0.026388, -0.105552,},},
},
constraint_sets = {
},
frames = {
	...
	markers = {
		...
		L_IPS = 	{ -0.095487, 0.095487, 0.095487,},
		R_IPS = 	{ -0.095487, -0.095487, 0.095487,},},
	visuals = {{
		src         = "pelvis.obj",
		dimensions  = 	{ 0.273000, 0.341250, 0.204616,},
	...
	visuals = {{
		src         = "thighR.obj",
		dimensions  = 	{ 0.197641, 0.158113, 0.474338,},
...
{		{ 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	...
	body = {
		mass   = 1.328900,
		com = 	{ -0.006314, 0.000000, -0.050500,},
		inertia = 
	...
	joint = 
		...
		{ 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		R_FM1 = 	{ 0.169151, 0.024164, -0.036247,},
		R_FM2 = 	{ 0.169151, 0.000000, -0.036247,},
		R_FM5 = 	{ 0.169151, -0.024164, -0.036247,},
		R_FCC = 	{ -0.072493, 0.000000, -0.036247,},},
	visuals = {{
		src         = "footR.obj",
		dimensions  = 	{ 0.241644, 0.119000, 0.101000,},
		mesh_center = 	{ 0.007822, 0.000000, -0.050500,},
		color       = 	{ 0.200000, 0.700000, 0.300000,},
		},},
	},
	{name   = "Thigh_L",
...
{		{ 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	...
	joint = 
		...
		{ 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		L_FM1 = 	{ 0.169151, -0.024164, -0.036247,},
		L_FM2 = 	{ 0.169151, 0.000000, -0.036247,},
		L_FM5 = 	{ 0.169151, 0.024164, -0.036247,},
	...
	joint = 
		...
		{ 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		SXS = 	{ 0.100880, 0.000000, 0.100880,},
		MAI = 	{ -0.100880, 0.000000, 0.100880,},
		LV1 = 	{ -0.100880, 0.000000, 0.000000,},
		LV3 = 	{ -0.100880, 0.000000, -0.050440,},},
	visuals = {{
		src         = "middleTrunk.obj",
		dimensions  = 	{ 0.245700, 0.300300, 0.302641,},
	...
	joint = 
		{},
	markers = {
		CV7 = 	{ -0.090666, 0.000000, 0.181332,},
		SJN = 	{ 0.095199, 0.000000, 0.135999,},
		TV2 = 	{ -0.090666, 0.000000, 0.135999,},},
	visuals = {{
		src         = "upperTrunk.obj",
		dimensions  = 	{ 0.171281, 0.326250, 0.237998,},
