...
metadata = {
	 ...
	 subject_heelAnkleXOffset = {0.1220},
...
points = {
	{name = "Pelvis_L", body = "Pelvis", point = {0.000000, 0.143943, 0.100760,},},
	{name = "Pelvis_R", body = "Pelvis", point = {0.000000, -0.143943, 0.100760,},},
	{name = "Pelvis_Back", body = "Pelvis", point = {-0.107957, 0.000000, 0.100760,},},
	{name = "Pelvis_Front", body = "Pelvis", point = {0.107957, 0.000000, 0.100760,},},
	{name = "Thigh_R", body = "Thigh_R", point = {0.083421, -0.000000, -0.312831,},},
	{name = "Heel_Medial_R", body = "Foot_R", point = {-0.122000, 0.063000, -0.102000,},},
	{name = "Heel_Lateral_R", body = "Foot_R", point = {-0.122000, -0.063000, -0.102000,},},
	{name = "Toe_R", body = "Foot_R", point = {0.069240, 0.000000, -0.102000,},},
	{name = "Thigh_L", body = "Thigh_L", point = {0.083421, 0.000000, -0.312831,},},
	{name = "Heel_Medial_L", body = "Foot_L", point = {-0.122000, -0.063000, -0.102000,},},
	{name = "Heel_Lateral_L", body = "Foot_L", point = {-0.122000, 0.063000, -0.102000,},},
	{name = "Toe_L", body = "Foot_L", point = {0.069240, 0.000000, -0.102000,},},
	{name = "UpperTrunk_Front", body = "UpperTrunk", point = {0.095672, 0.000000, 0.071754,},},
	{name = "UpperTrunk_Back", body = "UpperTrunk", point = {-0.107631, 0.000000, 0.095672,},},
	{name = "ProximalMetacarpal_Medial_R", body = "Hand_R", point = {-0.037127, 0.027845, -0.037127,},},
	{name = "ProximalMetacarpal_Lateral_R", body = "Hand_R", point = {0.037127, 0.027845, -0.037127,},},
	{name = "DistalMetacarpal_Medial_R", body = "Hand_R", point = {-0.037127, 0.027845, -0.111380,},},
	{name = "DistalMetacarpal_Lateral_R", body = "Hand_R", point = {0.037127, 0.027845, -0.111380,},},
	{name = "ProximalMetacarpal_Medial_L", body = "Hand_L", point = {-0.037127, -0.027845, -0.037127,},},
	{name = "ProximalMetacarpal_Lateral_L", body = "Hand_L", point = {0.037127, -0.027845, -0.037127,},},
	{name = "DistalMetacarpal_Medial_L", body = "Hand_L", point = {-0.037127, -0.027845, -0.111380,},},
	{name = "DistalMetacarpal_Lateral_L", body = "Hand_L", point = {0.037127, -0.027845, -0.111380,},},
},
constraint_sets = {
},
frames = {
	...
	markers = {
		...
		L_IPS = 	{ -0.100760, 0.100760, 0.100760,},
		R_IPS = 	{ -0.100760, -0.100760, 0.100760,},},
	visuals = {{
		src         = "pelvis.obj",
		dimensions  = 	{ 0.233000, 0.291250, 0.215914,},
...
{		{ 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	...
	body = {
		mass   = 1.370000,
		com = 	{ -0.009423, 0.000000, -0.051000,},
		inertia = 
	...
	joint = 
		...
		{ 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		R_FM1 = 	{ 0.178491, 0.025499, -0.038248,},
		R_FM2 = 	{ 0.178491, 0.000000, -0.038248,},
		R_FM5 = 	{ 0.178491, -0.025499, -0.038248,},
		R_FCC = 	{ -0.076496, 0.000000, -0.038248,},},
	visuals = {{
		src         = "footR.obj",
		dimensions  = 	{ 0.254987, 0.126000, 0.102000,},
		mesh_center = 	{ 0.005493, 0.000000, -0.051000,},
		color       = 	{ 0.200000, 0.700000, 0.300000,},
		},},
	},
	{name   = "Thigh_L",
...
{		{ 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	...
	joint = 
		...
		{ 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		L_FM1 = 	{ 0.178491, -0.025499, -0.038248,},
		L_FM2 = 	{ 0.178491, 0.000000, -0.038248,},
		L_FM5 = 	{ 0.178491, 0.025499, -0.038248,},
		L_FCC = 	{ -0.076496, 0.000000, -0.038248,},},
	visuals = {{
		src         = "footL.obj",
		dimensions  = 	{ 0.254987, 0.126000, 0.102000,},
		mesh_center = 	{ 0.005493, 0.000000, -0.051000,},
	...
	joint = 
		...
		{ 0.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000,},},
	markers = {
		SXS = 	{ 0.106450, 0.000000, 0.106450,},
		MAI = 	{ -0.106450, 0.000000, 0.106450,},
		LV1 = 	{ -0.106450, 0.000000, 0.000000,},
		LV3 = 	{ -0.106450, 0.000000, -0.053225,},},
	visuals = {{
		src         = "middleTrunk.obj",
		dimensions  = 	{ 0.209700, 0.256300, 0.319351,},
	...
	joint = 
		{},
	markers = {
		CV7 = 	{ -0.095672, 0.000000, 0.191344,},
		SJN = 	{ 0.100456, 0.000000, 0.143508,},
		TV2 = 	{ -0.095672, 0.000000, 0.143508,},},
	visuals = {{
		src         = "upperTrunk.obj",
		dimensions  = 	{ 0.166687, 0.317500, 0.251139,},
