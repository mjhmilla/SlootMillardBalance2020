        ...
        if( (timeQuietStanding) >= quietDwellTime)
          ...
          if((timeQuietSitting) >= quietDwellTime)
            ...
            if(standingChangeInAngSpeed < endS2SAngularVelocityTolerance)
              ...
              if(minAngSpeed > endS2SAngularVelocityTolerance)
                standingAngSpeed = endS2SAngularVelocityTolerance;
              else
                standingAngSpeed = minAngSpeed + 0.5*endS2SAngularVelocityTolerance;
              end
            ...
            while(indexStanding < indexStandingEnd ...
                  ...
                  ||  angSpeed(indexStanding) > standingAngSpeed)
