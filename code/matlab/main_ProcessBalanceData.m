...
%
%thresholdLowForce                      = 10; %N
%thresholdHighNormalizedForce          = 0.95;
%thresholdStaticSittingBalanceDistance  = 0.05; 
thresholdNormDistanceBelowStanding     = 0.4;         
%thresholdNormDistanceAboveSitting      = 0.5;
    ...
    if(indexTrial ~= index_Static)
      ...
      if(flag_loadKeyPointDistanceToFootConvexHull==0)
        ...
        fpe2FootConvexHullDist = processDistanceToConvexHull(...
                                    ...
                                    c3dMarkers,...
                                    c3dFootMarkerNames);          
         save([outputTrialFolder,outputFpeToFootHullDistanceFileName],...
        ...
        cap2FootConvexHullDist = processDistanceToConvexHull(...
                                    ...
                                    c3dMarkers,...
                                    c3dFootMarkerNames);          
         save([outputTrialFolder,outputCapToFootHullDistanceFileName],...
        ...
        comgp2FootConvexHullDist = processDistanceToConvexHull(...
                                    ...
                                    c3dMarkers,...
                                    c3dFootMarkerNames);          
         save([outputTrialFolder,outputComGPToFootHullDistanceFileName],...
        ...
        cop2FootConvexHullDist = processDistanceToConvexHull(...
         ...
         save([outputTrialFolder,outputCopToFootHullDistanceFileName],...
      ...
      %standingDelta = 1-thresholdNormStandingHeight;
      %sittingDelta  = thresholdNormSittingHeight-1;
            
      thresholdStanding = maxComHeight ...
        - thresholdNormDistanceBelowStanding*(maxComHeight-minComHeight);      
      %thresholdSitting  = minComHeight ...
      %  + thresholdNormDistanceAboveSitting*(maxComHeight-minComHeight);
