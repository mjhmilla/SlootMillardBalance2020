...
meshupGrfFileName = [dataFolderCSV,...
  c3dFileName(1:1:(strfind( c3dFileName,'.')-1)),'.ff'];   

meshupFpeFileName = [dataFolderCSV,...
  c3dFileName(1:1:(strfind( c3dFileName,'.')-1)),'_fpe.csv'];   
%%
% Constants
%%
...
[c3dTime, ...
 ...
 c3dGrf] = getC3DTrialData( dataFolderC3D,dataFolderMat, c3dFileName,...
                    flag_loadMatFileData, flag_useMetersRadiansInC3DData, ...
                    flag_verbose);
...
if(flag_writeRBDLToolChainFiles == 1)        
  ...
  %
  success = writeMeshupGroundForcesFile(meshupGrfFileName,c3dTime, ...
                                        indexPadding, c3dGrf);
  
  success = write3DFootPlacementDataFile(meshupFpeFileName,c3dTime, ...
                                          indexPadding, fpeData);
end
